 ...
 *  BLE_TEST_ENABLED is defined in ble.h, this function will change
 ...
 *
 * @details
 * 	This function simply removes the LEUART)_TX_DONE_EVT from the scheduler
 *
 ******************************************************************************/
